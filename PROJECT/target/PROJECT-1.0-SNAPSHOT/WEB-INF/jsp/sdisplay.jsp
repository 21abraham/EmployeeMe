  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <form:form id="edit" action="sdisplayform" method="post" commandName="ssForm">
    ...
    <div class="col-lg-2" style="margin-left: 500px">
        ...
        <input style="padding: 10px 100px 10px 100px;border: none;background-color: greenyellow; color: white;" type="submit" value="Submit">
                ...
                <a style="text-decoration: none;" href="allsdisplay.htm"><button style="padding: 10px 100px 10px 100px;border: none; background-color: greenyellow;color: white;" type="button">Display All Records</button></a>
            </div>
            </form:form>
        </div>
