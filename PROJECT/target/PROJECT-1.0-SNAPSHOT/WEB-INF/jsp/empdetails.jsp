  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <form:form id="edit" action="empdetailsform" method="post" commandName="empForm" enctype="multipart/form-data">
        <div class="row" >
        <div class="col-lg-2">
    ...
    <div class="col-lg-2" style="margin-left: 500px">
        ...
        <div class="col-lg-2">
            <div style="padding: 20px 0 0 0;">
            <label>State <form:input placeholder="Enter Employee State" type="text" path="emp_state" required="required"/></label>
            </div>
        </div>
    <div class="col-lg-2" style="margin-left: 500px">
        <div style="padding: 20px 0 0 0;">
        <label>Pincode <form:input placeholder="Enter Employee Pincode" type="number" path="emp_pincode"/></label>
        </div>
    </div>
  </div>
            <div class="row" >
    ...
    <div class="col-lg-2" style="margin-left: 500px">
        <div style="padding: 20px 0 0 0;">
        <label>Upload Pan Card Image <input type="file" name="file" accept="image/*" required="required"/></label>
        </div>
    </div>
  </div>
            <div class="container" style="padding: 100px 0 0 400px;">
                ...
                <a style="text-decoration: none;" href="empdetails.htm"><button style="padding: 10px 100px 10px 100px;border: none; background-color: greenyellow;color: white;" type="button">Clear</button></a>
            </div>
            </form:form>
        </div>
