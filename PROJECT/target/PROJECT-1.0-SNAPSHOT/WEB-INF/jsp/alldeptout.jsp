<%-- 
    ...
    Author     : hp
--%>
<%@page import="com.pack.alldepartmentclass"%>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <table>
            ...
            <%ArrayList<alldepartmentclass> std
                        = (ArrayList<alldepartmentclass>) request.getAttribute("list");
                for (alldepartmentclass s : std) {%>
                <tr>
                    <td><%=s.getDept_id()%></td>
