        ...
        <li class="nav-item">
          <a style="color: white;" class="nav-link" href="register.htm">Register</a>
            ...
            <b style="font-size:30px;color: white;">Employ Me</b>
               ...
               <form id="edit2" action="changeform" method="post">
        <div id="id1"><h3>New Password</h3></div>
            <input placeholder="Enter New Password" type="password" name="pwd" required="required">
            <br>
            <br>
