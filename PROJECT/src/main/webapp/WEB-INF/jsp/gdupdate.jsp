  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <div class="container" style="text-align: center;">
            <b style="font-size:50px;">Update Grade Details</b>
    </div>
        <div class="container" style="padding: 0 0 200px 50px;">
        <form:form id="edit" action="gdupdateform" method="post" commandName="gdForm">
        <div class="row" >
        <div class="col-lg-2">
            <div style="padding: 20px 0 0 0;">
                <label>Old Employee-ID <input placeholder="Enter Employee-ID" type="number" name="f" required="required"></label>
            </div>
        </div>
    <div class="col-lg-2" style="margin-left: 500px">
        <div style="padding: 20px 0 0 0;">
        <label>New Employee-ID <form:input placeholder="Enter Employee-ID" type="number" path="emp_id" required="required"/></label>
        </div>
    </div>
  </div>
            <div class="row" >
    ...
    <div class="col-lg-2" style="margin-left: 500px">
        <div style="padding: 20px 0 0 0;">
            ...
            <div class="container" style="padding: 100px 0 0 400px;">
                ...
                <a style="text-decoration: none;" href="gdupdate.htm"><button style="padding: 10px 100px 10px 100px;border: none; background-color: greenyellow;color: white;" type="button">Clear</button></a>
            </div>
            </form:form>
        </div>
