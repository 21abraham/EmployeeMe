  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <div class="container" style="text-align: center;">
            <b style="font-size:50px;">Update Department Details</b>
    </div>
        <div class="container" style="padding: 0 0 200px 50px;">
        <form:form id="edit" action="depupdateform" method="post" commandName="ddForm">


            <div class="row" >
        <div class="col-lg-2">
            <div style="padding: 20px 0 0 0;">
            <label>Old Department ID <input placeholder="Enter Department ID" type="number" name="a" required="required"></label>
            </div>
        </div>
    <div class="col-lg-2" style="margin-left: 500px">
        <div style="padding: 20px 0 0 0;">
        <label>New Department ID <form:input placeholder="Enter Department ID" type="number" path="dept_id" required="required"/></label>
        </div>
    </div>
  </div>
            <div class="row" >
        <div class="col-lg-2">
            <div style="padding: 20px 0 0 0;">
            <label>New Department Name <form:input placeholder="Enter Department Name" type="text" path="dept_name" required="required"/></label>
            </div>
        </div>
    <div class="col-lg-2" style="margin-left: 500px">
        <div style="padding: 20px 0 0 0;">
