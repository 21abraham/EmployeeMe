        ...
        <li class="nav-item">
          <a style="color: white;" class="nav-link" href="loginform.htm">Login</a>
            ...
            <b style="font-size:30px;color: white;">Employ Me</b>
                ...
                <form:form id="edit2" action="registerform" method="post" commandName="adminregForm">
        <div id="id1"><h3>User ID</h3></div>
            <form:input placeholder="Enter User-ID" type="number" path="userid" required="required"/>
        <div id="id1"><h3>Username</h3></div>
            <form:input placeholder="Enter Username" type="text" path="username" required="required"/>
        <div id="id1"><h3>Password</h3></div>
            <form:input placeholder="Enter Password" type="password" path="password" required="required"/>
            <div id="id1"><h3>Email</h3></div>
            <form:input placeholder="Enter Email" type="email" path="email" required="required"/>
        <div id="id1"><h3>Usertype</h3></div>
            <form:input placeholder="Enter User-type" type="text" path="usertype" required="required"/>
            <br>
            <br>
            <input style="width: 100%;border: none;" class="btn btn-success" type="submit" value="Enter">
