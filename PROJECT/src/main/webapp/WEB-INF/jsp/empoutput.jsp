  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <table>
            <%
         String m=(String) request.getAttribute("empid");
                    try{
                        Connection con=DBUtil.getDataSource().getConnection();
                        PreparedStatement stmt = con.prepareStatement("select * from employeetable where emp_id="+m);
            ...
            <tr>
                <td><%=rs.getLong("emp_id")%></td>
              <td><%=rs.getString("emp_title")%></td>
              <td><%=rs.getString("emp_name")%></td>
              <td><%=rs.getString("emp_dob")%></td>
              <td><%=rs.getString("emp_doj")%></td>
              <td><%=rs.getString("emp_address")%></td>
              <td><%=rs.getString("emp_city")%></td>
              <td><%=rs.getString("emp_pincode")%></td>
              <td><%=rs.getLong("emp_mobile_no")%></td>
              <td><%=rs.getString("emp_state")%></td>
              <td><%=rs.getString("emp_mail_id")%></td>
              <td><%=rs.getString("emp_pan_no")%></td>
