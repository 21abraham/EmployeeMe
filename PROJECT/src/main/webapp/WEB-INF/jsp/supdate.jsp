  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <div class="container" style="text-align: center;">
            <b style="font-size:50px;">Update Salary Details</b>
    </div>
        <div class="container" style="padding: 0 0 200px 50px;">
        <form:form id="edit" action="supdateform" method="post" commandName="ssForm">
        <div class="row" >
        <div class="col-lg-2">
            <div style="padding: 20px 0 0 0;">
                <label>Old Employee ID <input placeholder="Enter Employee ID" type="number" name="g" required="required"></label>
    ...
    <div class="col-lg-2" style="margin-left: 500px">
        ...
        <label>Transaction ID <form:input placeholder="Enter Transaction ID"  type="number" path="transaction_id" required="required"/></label>
            ...
            <div class="container" style="padding: 100px 0 0 400px;">
                ...
                <a style="text-decoration: none;" href="supdate.htm"><button style="padding: 10px 100px 10px 100px;border: none; background-color: greenyellow;color: white;" type="button">Clear</button></a>
            </div>
            </form:form>
        </div>
