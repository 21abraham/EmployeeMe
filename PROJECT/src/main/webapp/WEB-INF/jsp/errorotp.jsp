...
<html>
  ...
  <form id="edit2" action="verifyform" method="post">
        <div id="id1"><h3>OTP</h3></div>
            <input placeholder="Enter OTP" type="text" name="otpnum" required="required">
            <br>
            <br>
            <input style="width: 100%;border: none;" class="btn btn-success" type="submit" value="Verify">
