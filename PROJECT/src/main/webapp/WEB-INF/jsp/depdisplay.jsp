...
<html>
    <head>
        ...
        <title>Display Department Details</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <div class="container" style="text-align: center;">
            <b style="font-size:50px;">Display Department Details</b>
    </div>
        <div class="container" style="padding: 0 0 200px 50px;">
        <form:form id="edit" action="depdisplayform" method="post" commandName="ddForm">
    ...
    <div class="col-lg-2" style="margin-left: 500px">
        ...
        <input style="padding: 10px 100px 10px 100px;border: none;background-color: greenyellow; color: white;" type="submit" value="Submit">
            ...
            <div style="padding: 100px 0 0 400px;">
                <a style="text-decoration: none;" href="alldepdisplay.htm"><button style="padding: 10px 100px 10px 100px;border: none; background-color: greenyellow;color: white;" type="button">Display All Records</button></a>
            </div>
