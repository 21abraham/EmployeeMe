...
<html>
    <head>
        ...
        <title>Delete Grade Table Details</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <div class="container" style="text-align: center;">
            <b style="font-size:50px;">Delete Grade Table Details</b>
    </div>
        <div class="container" style="padding: 0 0 200px 50px;">
        <form:form id="edit" action="gtdeleteform" method="post" commandName="ggForm">
